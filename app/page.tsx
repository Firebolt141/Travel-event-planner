...
export default function HomePage() {
  ...
  const todosForDateCombined = useMemo<GlobalTodoWithSource[]>(() => {
    return [...globalTodosForDate].sort(compareTodos);
  }, [globalTodosForDate]);

  const todosSoon = useMemo<GlobalTodoWithSource[]>(() => {
    const fromGlobal = (globalTodos || []).map((t) => ({ ...t, source: "global" as const }));
    const all: GlobalTodoWithSource[] = [...fromGlobal];
          ...
          <div className="card-cute">
            ...
            <div className="grid grid-cols-7 gap-2">
              {days.map((day, i) => {
                ...
                const todosOnDay = [...globalTodosOnDay];
